...
/** Rate limiter for Opinion API – 15 req/s (hard limit per docs) */
export const opinionRateLimiter = new RateLimiter(15);

/** Rate limiter for Predict.fun API – 240 req/min = 4 req/s (mainnet docs) */
export const predictFunRateLimiter = new RateLimiter(4);
