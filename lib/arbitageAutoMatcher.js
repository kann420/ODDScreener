 ...
 */
export async function fetchAllOpinionMarkets({ limit = 20, maxPages = 50 } = {}) {
  ...
  console.log(`[AutoMatcher] Fetching binary markets (marketType=0)...`);
  ...
  console.log(`[AutoMatcher] Fetching categorical parent markets (marketType=1)...`);
  ...
  for (let i = 0; i < categoricalParents.length; i += BATCH_SIZE) {
